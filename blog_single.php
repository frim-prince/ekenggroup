    ...
    <div class="row">
       <div class="col-sm-7 col-md-6">
          <div class="inner-text">
           <h3>May 17, 2020 Posted by <span>Nhyiraba Agyei</span> In : <span>Ekeng Operation</span></h3>
       </div>
       </div>
        <div class="col-sm-5 col-md-6">
            <ul class="mbm_social">
            	<li><a class="social-facebook" href="www.facebook.com/theekenggroups">
            		<i class="fa fa-facebook"><small>1.2m</small></i>
            		
            		<div class="tooltip"><span>facebook</span></div>
            		</a>
            	</li>
            	<li><a class="social-twitter" href="twitter@theekeng">
    ...
    <div class="container">
       <div class="row" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-duration="1000">
           <ul>
               ...
               <li><a href="contact.php">contact</a></li><li class="semicolon">|</li>
